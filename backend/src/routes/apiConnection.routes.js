...
router.patch( '/connections/:id/deactivate', apiConnectionController.deactivateConnection );

router.patch( '/connections/:id/activate', apiConnectionController.activateConnection );
